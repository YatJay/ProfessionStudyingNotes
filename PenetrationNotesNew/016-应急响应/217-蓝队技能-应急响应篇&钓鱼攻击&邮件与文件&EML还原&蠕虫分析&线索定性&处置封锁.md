...
----MagicMail--9f0ea65ae0f1a637
Content-Type: multipart/alternative;
	boundary="--MagicMail--e965f40d8ac4f0d8"


----MagicMail--e965f40d8ac4f0d8
Content-Type: text/plain;
	charset="utf-8"
Content-Transfer-Encoding: base64


hueggeS4ujIwMjFAMTIzNDU2
...

0ibWFyZ2luLXRvcDogMHB0OyBtYXJnaW4tYm90dG9tOiAwcHQ7Ij48L3A+

----MagicMail--e965f40d8ac4f0d8--

----MagicMail--9f0ea65ae0f1a637
Content-Type: application/x-z;
	name="=?utf-8?B?55S16ISR5a6J5YWo5qOA5p+l5bel5YW3LnppcA==?="
Content-Transfer-Encoding: base64
Content-Disposition: attachment;
	filename="=?utf-8?B?55S16ISR5a6J5YWo5qOA5p+l5bel5YW3LnppcA==?="

UEsDBBQDAQgIAIB+RVPP3......
```
...
将域名`mail.ffcs.cn`和IP地址`61.154.14.126`使用在线情报平台查询，结果是域名是白域名，IP存在风险，说明mail.ffcs.cn确实为官方邮件服务器域名，但可能遭受过攻击，被攻击后被配置成了钓鱼邮件服务器

![image-20251009201505143](https://img.yatjay.top/md/20251009201505201.png)

![image-20251009201548048](https://img.yatjay.top/md/20251009201548095.png)
...
邮件服务器 `mail.ffcs.cn`在其本地，使用 `qmail-scanner`（版本1.24）处理了一封由其自身（`127.0.0.1`）提交的邮件。该邮件的信封发件人地址为 `ffnic@ffcs.cn`。处理过程动用了root权限，并使用了ClamAV反病毒引擎（版本0.98.4，病毒库版本26074）对这封邮件进行了病毒扫描。

简单来说：这是一条记录，表明一封从本机发出的邮件已经成功被服务器的杀毒软件（ClamAV）扫描过了。
...
这封邮件是通过 “MagicMail”网页邮件系统的界面发送的。发送者当时登录该网页系统时，所使用的网络IP地址是 `121.204.224.15`（中国福建福州电信）。
...
这表示，这部分代码是以base64编码的，解码后得到

```
您好！<br /><br />近期微软高危漏洞爆发，已出现新型勒索病毒，为做好安全防护需对所有员工电脑进行安全自查，附件为安全检测程序。<br />烦请在电脑上执行此程序，若检测无问题，请回复，感谢！<br /><br />请勿外传本程序！<br /><br />解压密码为2021@123456<p style="margin-top: 0pt; margin-bottom: 0pt;"></p>
```
...
.....


CgAgAAAAAAABABgAgLkS4L251wGAuRLgvbnXAYCaCOa9udcBUEsFBgAAAAABAAEAaAAAAC4/DAAA
AA==
...
其中filename行中这部分`55S16ISR5a6J5YWo5qOA5p+l5bel5YW3LnppcA==`base64解码后为`电脑安全检查工具.zip`

下面大量的代码就是该zip文件的base64编码，将这段代码在Kali中解码并输出为一个zip文件

![image-20251010003154508](https://img.yatjay.top/md/20251010003154553.png)

解码后得到zip包，解压后得到电脑`安全检查工具.exe`

![image-20251010003236028](https://img.yatjay.top/md/20251010003236093.png)

将该exe文件用在线云沙箱分析，结果如下

![image-20251010004100188](https://img.yatjay.top/md/20251010004100288.png)

![image-20251010003120317](https://img.yatjay.top/md/20251010003120406.png)

由于该exe文件存在检测虚拟机的机制，因此找一个云服务器运行+安天进程分析工具来分析，可见进程存在外连行为，

![image-20251010002613887](https://img.yatjay.top/md/20251010002614016.png)

将外连IP地址进行情报查询，发现和木马相关行为

![image-20251010002856078](https://img.yatjay.top/md/20251010002856165.png)
