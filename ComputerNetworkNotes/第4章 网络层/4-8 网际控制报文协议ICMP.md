...
![image-20230909235442604](./assets/image-20230909235442604.png)
...
![image-20230909235646649](./assets/image-20230909235646649.png)

又例如， H1 给 H2 发送 IP 数据报，当该数据报传输到 H2 时，由于 H2 拥塞，就丢弃了该数据报，并向发送该数据报的源主机 H1 发送ICMP差错报告报文，其类型为源点抑制。

![image-20230909235721898](./assets/image-20230909235721898.png)
...
![image-20230909235841045](./assets/image-20230909235841045.png)

R2 丢弃该数据报，并向发送该数据报的源主机 H1 发送ICMP差错报告报文，其类型为时间超过。

![image-20230909235900991](./assets/image-20230909235900991.png)
...
![image-20230910000046385](./assets/image-20230910000046385.png)
...
![image-20230910000145528](./assets/image-20230910000145528.png)

当 R1 发现 H1 发往 N2 的数据报的最佳路由不应当经过R1，而是应当经过 R4 时，就用改变路由报文把这个情况告诉主机。

![image-20230910000247891](./assets/image-20230910000247891.png)
...
![image-20230910000521708](./assets/image-20230910000521708.png)
...
![image-20230910001153834](./assets/image-20230910001153834.png)
...
![image-20230910001407489](./assets/image-20230910001407489.png)
...
![image-20230910001603956](./assets/image-20230910001603956.png)
...
![image-20230910001709830](./assets/image-20230910001709830.png)
...
![image-20230910001841923](./assets/image-20230910001841923.png)

## 本节小结

![image-20230910001907979](./assets/image-20230910001907979.png)